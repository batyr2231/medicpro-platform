      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="flex gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-cyan-500 focus:outline-none"
              />
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <select
              ...
              className="px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-cyan-500 focus:outline-none"
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-slate-400 text-lg">Медики не найдены</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-1 px-3 py-1 rounded-full bg-yellow-500/20 border border-yellow-500/30">
                    ...
                    <span className="text-yellow-400 font-semibold">{medic.avgRating}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="text-lg font-bold">{medic.reviewCount}</div>
                  </div>
                </div>
